...
//==============================================================================
/**
    Base class for an MPE-compatible effect device that can transform MPE notes.

    This class extends MPEEffectBase by adding the concept of voices,
    ...
    from MPEEffectBase). The voices will be started, stopped, and modulated
    ...
    @see MPEEffectBase, MPEEffectVoice, MPENote, MPEInstrument

    @tags{Audio}
*/
class JUCE_API MPEEffect : public MPEEffectBase {
public:
    //==============================================================================
    /** Constructor.
    ...
    */
    ...
    /** Constructor to pass to the synthesiser a custom MPEInstrument object
        ...
        @see MPEEffectBase, MPEInstrument
    */
    MPEEffect(MPEInstrument& instrumentToUse);
    ...
    MPEEffectVoice* getVoice(int index) const;
    ...
    /** Adds a new voice to the synth.
        ...
        voice.
    */
    void addVoice(MPEEffectVoice* newVoice);
    ...
    */
    ...
    /** Tells the synthesiser what the sample rate is for the audio it's being used to render.
        ...
        This overrides the implementation in MPEEffectBase, to additionally
    ...
    */
    ...
    /** Handle incoming MIDI events.
        ...
        and then simply calls through to MPEEffectBase::handleMidiEvent to deal
...
protected:
    ...
    */
    void renderNextSubBlock(MidiBuffer& midiBuffer, int startSample, int numSamples) override;
    ...
    */
    virtual MPEEffectVoice* findFreeVoice(MPENote noteToFindVoiceFor, bool stealIfNoneAvailable) const;
    ...
    */
    virtual MPEEffectVoice* findVoiceToSteal(MPENote noteToStealVoiceFor = MPENote()) const;
    ...
    /** Starts a specified voice and tells it to play a particular MPENote.
        ...
        MPEEffectBase::instrument via the noteStarted callback,
        but is protected in case it's useful for some custom subclasses.
    */
    void startVoice(MPEEffectVoice* voice, MPENote noteToStart);
    ...
    /** Stops a given voice and tells it to stop playing a particular MPENote
        ...
        You should never need to call this, it's called internally by
        MPEEffectBase::instrument via the noteReleased callback,
        but is protected in case it's useful for some custom subclasses.
    */
    void stopVoice(MPEEffectVoice* voice, MPENote noteToStop, bool allowTailOff);

    //==============================================================================
    OwnedArray<MPEEffectVoice> voices;
...
private:
    ...
    mutable Array<MPEEffectVoice*> usableVoicesToStealArray;
